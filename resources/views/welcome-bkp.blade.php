...
<head>
    ...
    @vite(['resources/css/app.css', 'resources/js/app.js', './node_modules/preline/dist/*.js'])
</head>
    ...
    <nav class="relative max-w-[66rem] w-full bg-neutral-800 rounded-[28px] py-3 ps-5 pe-2 md:flex md:items-center md:justify-between md:py-0 mx-2 lg:mx-auto" aria-label="Global">
        ...
        <div id="navbar-collapse" class="hs-collapse hidden overflow-hidden transition-all duration-300 basis-full grow md:block">
            <div class="flex flex-col gap-y-4 gap-x-0 mt-5 md:flex-row md:items-center md:justify-end md:gap-y-0 md:gap-x-7 md:mt-0 md:ps-7">
                <a class="text-sm text-white hover:text-neutral-300 md:py-4 focus:outline-none focus:text-neutral-300" href="/" aria-current="page">{{__("Home")}}</a>
                <a class="text-sm text-white hover:text-neutral-300 md:py-4 focus:outline-none focus:text-neutral-300" href="/stories">{{__("Stories")}}</a>
                <a class="text-sm text-white hover:text-neutral-300 md:py-4 focus:outline-none focus:text-neutral-300" href="/about">{{__("About")}}</a>
                <a class="text-sm text-white hover:text-neutral-300 md:py-4 focus:outline-none focus:text-neutral-300" href="/polls">{{__("Polls")}}</a>
                <!-- Dropdown -->
                @if (Route::has('login'))
                    <div class="hs-dropdown [--strategy:static] md:[--strategy:fixed] [--adaptive:none] md:py-4">
                        ...
                        <div class="hs-dropdown-menu transition-[opacity,margin] duration-[0.1ms] md:duration-[150ms] hs-dropdown-open:opacity-100 opacity-0 md:w-48 hidden z-10 bg-neutral-800 md:shadow-md rounded-lg p-2 before:absolute top-full before:-top-5 before:start-0 before:w-full before:h-5">
                            @auth
                                <a class="flex items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm text-white hover:text-neutral-300 font-medium focus:outline-none focus:text-neutral-300" href="{{ route('profile') }}">
                                    {{__("Profile")}}
                                </a>
                            @else
                                <a class="flex items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm text-white hover:text-neutral-300 font-medium focus:outline-none focus:text-neutral-300" href="{{ route('login') }}">
                                    {{__("Log in")}}
                                </a>
                                <a class="flex items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm text-white hover:text-neutral-300 font-medium focus:outline-none focus:text-neutral-300" href="{{ route('register') }}">
                                    {{__("Register")}}
                                </a>
                            @endauth
...
<main id="content">
    ...
    <div class="bg-neutral-900">
        <div class="max-w-5xl mx-auto px-4 xl:px-0 pt-24 lg:pt-32 pb-24">
            <h1 class="font-semibold text-white text-5xl md:text-6xl">
                <span class="text-[#ff0]">Molnár Fémművek:</span> A fémmegmunkálás gyerekjáték
            </h1>
            <div class="max-w-4xl">
                <p class="mt-5 text-neutral-400 text-lg">
                    Légy üdvözölve a honlapunkon.
                    A Molnár Fémműveknél az ötletek valódi formát öltenek.
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="relative overflow-hidden pt-4 bg-neutral-900">
        ...
        <div class="relative z-10">
            <div class="max-w-5xl px-4 xl:px-0 mx-auto">
                <div class="mb-4">
                    <h2 class="text-neutral-400">Megbízható munkavégzés több évtizedes múlttal, és mégtöbb jövővel</h2>
                </div>
    ...
    <div class="bg-neutral-900 bg-gradient-to-t from-black to-transparent">
        <div class="max-w-5xl px-4 xl:px-0 py-24 mx-auto">
            ...
            <div class="max-w-3xl mb-10 lg:mb-14">
                <h2 class="text-white font-semibold text-2xl md:text-4xl md:leading-tight">Sikertörténetünk</h2>
                <p class="mt-1 text-neutral-400">A cégekkel, amelyekkel rendszeresen együtt dolgozunk jó kapcsolatot ápolunk, de a hangulaton kívül is szemmel látható eredményeket tudunk felmutatni.</p>
            </div>
            <!-- End Title -->
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 items-center border border-neutral-700 divide-y lg:divide-y-0 lg:divide-x divide-neutral-700 rounded-xl">
                ...
                <a class="group relative z-10 p-4 md:p-6 h-full flex flex-col bg-neutral-900 first:rounded-t-xl last:rounded-b-xl lg:first:rounded-l-xl lg:first:rounded-tr-none lg:last:rounded-r-xl lg:last:rounded-bl-none before:absolute before:inset-0 before:bg-gradient-to-b before:hover:from-transparent before:hover:via-transparent before:hover:to-[#ff0]/10 before:via-80% before:-z-[1] before:last:rounded-b-xl lg:before:first:rounded-s-xl lg:before:last:rounded-e-xl lg:before:last:rounded-bl-none before:opacity-0 before:hover:opacity-100" href="#">
                    <div class="mb-5">
                        ...
                        <div class="mt-5">
                            <p class="font-semibold text-5xl text-white">43%</p> {{-- mennyiseg, mertekegyseg --}}
                            <h3 class="mt-5 font-medium text-lg text-white">Enhancement in Customer Engagement</h3> {{-- Cim --}}
                            {{-- Rovid leiras --}}
    ...
    <div class="bg-neutral-900">
        <div class="max-w-5xl px-4 xl:px-0 py-10 lg:py-20 mx-auto">
            <!-- Title -->
            <div class="max-w-3xl mb-10 lg:mb-14">
                <h2 class="text-white font-semibold text-2xl md:text-4xl md:leading-tight">{{ __('Reviews') }}</h2>
                <p class="mt-1 text-neutral-400">With over 30 awards, and achievements, we proudly demonstrate our unwavering dedication to excellence and collaboration successes.</p>
            </div>
            <!-- End Title -->
                ...
                <div>
                    ...
                    <blockquote>
                        <p class="font-medium text-xl text-white md:text-2xl md:leading-normal xl:text-3xl xl:leading-normal">
                            Valaki idézzen már ide valamit, ha írtak a cégről jókat.
                        </p>
                        ...
                        <footer class="mt-6">
                            <div class="flex items-center">
                                ...
                                <div class="ms-4 md:ms-0">
                                    <div class="text-base font-semibold text-white">Ha a nevét is megadja, azt is ide González</div>
                                    <div class="text-xs text-neutral-400">Honnan jött | Mit keres itt</div>
                                </div>
                            </div>
                        </footer>
                    </blockquote>
    ...
    <div class="bg-neutral-900">
        ...
        <div class="max-w-5xl px-4 xl:px-0 py-10 lg:pt-20  mx-auto">
            <!-- Title -->
            <div class="max-w-3xl mb-10 lg:mb-14">
                <h2 class="text-white font-semibold text-2xl md:text-4xl md:leading-tight">{{__("Hogy kezdünk neki | Our App Roach")}}</h2>
                <p class="mt-1 text-neutral-400">Mélyreható betekintés vezérli átfogó stratégiánkat a részletes ötleteléstől és stratégiai tervezéstől kezdve a prototipikus megrendelésig és a késztermékek sorozatgyártásának zökkenőmentes végrehajtásáig.</p>
            </div>
            <!-- End Title -->
